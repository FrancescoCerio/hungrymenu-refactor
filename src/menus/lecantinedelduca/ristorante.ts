...
export const restaurantMenu: Section[] = [
  ...
  },
  {
    ...
    icon: 'contorni.png',
    dishes: [
      {name: 'Crocchette di baccalà e misticanza', description: '3 pz', price: '7,00'},
      {name: 'Insalata di baccalà con olive capperi e cipolla', description: '', price: '9,00'},
      {name: 'Pacchero ripieno al ragù di baccala gratinato al forno', description: '', price: '10,00'},
      {name: 'Nuvola di baccalà con frigitelli ', description: '3 pz', price: '12,00'},
      {name: 'Baccalà alla livornese', description: '', price: '12,00'},
    ]
  },
  {
    title: 'Antipasti',
  ...
  { title: 'Primi', url: 'primi', icon: 'primi.png',
    ...
    dishes: [
      {name: 'Caciocavallo arrosto miele e noci', description: '', price: '9,00'},
      ...
      {name: 'Straccetti di vitello al balsamico con rucola e scaglie', description: '', price: '11,00'},
    ...
    dishes: [
      ...
      {name: 'Insalatona di tonno', description: 'Insalata verde, rucola, radicchio, pomodorino pachino, tonno, cipolla', price: '7,50'},
    ...
    dishes: [
      ...
      {name: 'Diavola', description: 'Pomodoro, Fior di latte, salsiccia piccante', price: '8,00'},
      ...
      {name: 'Prosciutto', description: 'Pomodoro, Fior di latte, prosciutto cotto', price: '7,50'},
      {name: 'Super Diavola', description: 'Pomodoro, Fior di latte, salsiccia piccante, peperoni', price: '9,00'},
      {name: 'Tonno', description: 'Pomodoro, Fior di latte, tonno e cipolla', price: '8,50'},
    ...
    dishes: [
      ...
      {name: 'Americana', description: 'Fior di latte, wrustel, patatine fritte', price: '9,00'},
      {name: 'Carbonara', description: 'Fior di latte, guanciale, pecorino, uovo, pepe nero', price: '9,00'},
      {name: 'Crostino', description: 'Pizza con crudo dentro e sopra rucola e pomodorini', price: '9,00'},
      {name: 'Guanciale', description: 'Fior di latte, guanciale, pecorino romano', price: '9,00'},
      ...
      {name: 'Ortolana', description: 'Fior di latte, melanzane, zucchine, peperoni', price: '8,50'},
    ...
    dishes: [
      {name: 'Affumicata', description: 'Fior di latte, zucchine grattugiate, salmone affumicato', price: '10,50'},
      ...
      {name: 'La Partenopea', description: 'Pinsa bianca condita con pesto di basilico, provola, alici, peperoncino e un filo d’olio extravergine d’oliva completata all’uscita con scorza di limone', price: '8,50'},
    ...
    dishes: [
      ...
      {name: 'Amari', description: '', price: '3,00'},
